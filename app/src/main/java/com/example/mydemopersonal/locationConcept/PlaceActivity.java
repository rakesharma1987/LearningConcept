...
import com.example.mydemopersonal.adapters.PlaceRecyclerviewAdapter;
import com.example.mydemopersonal.interfaces.ApiInterface;
import com.example.mydemopersonal.model.PlacesPOJO;
import com.example.mydemopersonal.model.ResultDistanceMatrix;
import com.example.mydemopersonal.model.StoreModel;
import com.example.mydemopersonal.retrofit.APIClient;
                ...
                if ("OK".equalsIgnoreCase(resultDistance.status)) {
                    ...
                    if ("OK".equalsIgnoreCase(distanceElement.status)) {
                        ...
                        if (storeModels.size() == 10 || storeModels.size() == results.size()) {
                            PlaceRecyclerviewAdapter adapterStores = new PlaceRecyclerviewAdapter(results, storeModels);
